...
describe("validateEvmValue", () => {
    ...
    describe("address", () => {
        ...
        it("should reject invalid addresses", () => {
            ...
            expect(validateEvmValue(addressTooShort, "address")).toBe(false); // too short
            expect(validateEvmValue(addressMissing0x, "address")).toBe(false); // no 0x
    ...
    describe("dynamic bytes", () => {
        it("should validate dynamic bytes", () => {
            ...
            expect(validateEvmValue("0x123", "bytes")).toBe(false); // odd length
        });
    });
